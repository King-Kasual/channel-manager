...
class sql:
    ...
    @staticmethod
    def add_channel(  # pylint: disable=too-many-arguments,too-many-positional-arguments
        ...
        try:
            ...
            session.execute(
                text(
                    f"insert into {table} (channel_ID, name, guild_ID) "
    ...
    def update_channel_guild_id(db, table, channel_id, guild_id, debug=False):
        ...
        try:
            ...
            session.execute(
                text(
                    f"update {table} set guild_id = :guild_id "
                    "where channel_ID = :channel_id;"
                ),
